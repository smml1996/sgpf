...
class Concept_Manager(models.Manager):
...
class Concept(models.Model):
    ...
    #we use this meta inner class to get a unique identifier when concept is used as foreign key in a Daily_Input
        #useful for serialization and retrieving the concept id to some interface
    class Meta:
        unique_together = (('name', 'id'))

class Daily_Input(models.Model):
